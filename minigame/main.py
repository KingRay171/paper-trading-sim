...
def draw_shop(game, player):
    ...
    lineUps = []
    lineUps.append(fontsmall.render(f"Peirce: {player.DART_PIERCE}", True, (255, 255, 255)))
    lineUps.append(fontsmall.render(f"Fire Rate: {player.FIRE_RATE}", True, (255, 255, 255)))
    lineUps.append(fontsmall.render(f"Damage: {game.DART_DAMAGE}", True, (255, 255, 255)))
    lineUps.append(fontsmall.render(f"Bullet speed: {player.DART_SPEED}", True, (255, 255, 255)))
...
class Game():
   ...
   # Create the new enemy and add it to sprite groups
    ...
    def spawn_time(self, enemyGroup, projectileGroup, allGroup):
...
while running:
    ...
    if game_over == False and paused == False:
        ...
        if(game.ENEMY_WAVE ==0):
          line = fontsmall.render("Hit enter to start a wave", True, (255, 255, 255))
        else:
          line = fontsmall.render(f"Enemies left: {game.ENEMY_WAVE}", True, (255, 255, 255))
